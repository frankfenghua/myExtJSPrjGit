/*
 * File: app/controller/GUSJsonTreepanelController.js
 *
...
Ext.define('MyApp.controller.GUSJsonTreepanelController', {
    extend: 'Ext.app.Controller',

    refs: [
        {
            ref: 'GUSJsonTreePanel',
            selector: '#gusjsontreepanel'
        },
        {
            ref: 'UserGridPanel',
...
//            var node = this.getGUSJsonTreePanel().getStore().getRootNode().data;
            var node = this.getGUSJsonTreePanel().getStore().getRootNode();
